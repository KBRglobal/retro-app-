      ...
      <div className="flex-1 flex flex-col overflow-hidden">
        <header className="h-20 bg-white/80 backdrop-blur-md border-b border-[#F0F2F5] flex items-center justify-between px-10 shrink-0 z-10">
          <div className="flex items-center gap-6">
            <button className="flex items-center gap-2 text-xs font-black text-[#64748B] hover:text-[#0F172A] transition-colors group">
          ...
          <main className="flex-1 overflow-y-auto p-12 max-w-5xl mx-auto w-full">
            <div className="mb-12">
              ...
              <div className="flex flex-wrap gap-2">
                <span className="px-4 py-1.5 rounded-2xl bg-red-50 text-red-600 text-xs font-black uppercase tracking-widest border border-red-100 shadow-sm shadow-red-500/5">
                  Security
                </span>
                <span className="px-4 py-1.5 rounded-2xl bg-blue-50 text-blue-600 text-xs font-black uppercase tracking-widest border border-blue-100 shadow-sm shadow-blue-500/5">
                  Infrastructure
                </span>
                <span className="px-4 py-1.5 rounded-2xl bg-[#F0F2F5] text-[#64748B] text-xs font-black uppercase tracking-widest border border-transparent">
                  Eng-Lead
                </span>
              </div>
            </div>
            <section className="space-y-8">
              <div className="flex items-center justify-between border-b border-[#F0F2F5] pb-6">
                ...
                <div className="text-[10px] font-black text-[#64748B] uppercase tracking-[0.2em] bg-white px-4 py-2 rounded-xl border border-[#F0F2F5]">
                  14 Atomic Commits Verified
                </div>
              </div>
              <div className="space-y-6">
                <div className="group relative flex gap-6 bg-white p-6 rounded-[2rem] border border-[#F0F2F5] shadow-sm hover:shadow-xl hover:scale-[1.01] transition-all">
                  ...
                  <div className="flex-1 min-w-0 space-y-3">
                    ...
                    <div className="flex items-center gap-6">
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-[10px] font-mono font-black text-red-500">-244</span>
                ...
                <div className="flex items-center gap-6 px-10">
                  <div className="w-1 h-12 bg-gradient-to-b from-indigo-100 to-transparent rounded-full ml-5" />
                  <p className="text-xs font-black text-[#64748B] uppercase tracking-widest italic">
                    Tracing 12 additional engineering logs...
                  </p>
                </div>
              </div>
            </section>
          ...
          <aside className="w-96 bg-white border-l border-[#F0F2F5] overflow-y-auto shrink-0 z-10 p-10 space-y-12">
            <section>
              ...
              <div className="flex items-center gap-4 bg-[#FBFBFF] p-4 rounded-3xl border border-[#F0F2F5]">
                ...
                />
                <div>
                  <p className="text-lg font-black text-[#0F172A] leading-tight">Backend Lead</p>
              ...
              <div className="space-y-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-lg font-bold">12.0h</p>
                  </div>
                  <div>
            ...
            <section className="space-y-4">
              <div className="flex items-center gap-4 p-4 rounded-2xl hover:bg-[#FBFBFF] transition-all cursor-default group">
                ...
                <div>
                  ...
                  <p className="text-sm font-extrabold text-[#0F172A]">May 12, 2024</p>
                </div>
              </div>
              <div className="flex items-center gap-4 p-4 rounded-2xl hover:bg-[#FBFBFF] transition-all cursor-default group">
                ...
                <div>
                  ...
                  <p className="text-sm font-extrabold text-[#0F172A]">May 13, 2024</p>
                </div>
              </div>
            </section>
          </aside>
